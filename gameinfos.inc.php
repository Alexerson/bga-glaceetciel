...
$gameinfos = [
  ...
  "player_colors" => ["419dcf", "c27d71", "f8c079", "92b789"],
  ...
  "presentation" => [
    totranslate("Never has a game made you so dependent on each other!"),
    totranslate(
      "Be the guardians of the subtle and permanent balance between life and the elements in which it evolves: air, earth and water. There is nothing you can do on your own to protect this nifty scale, so you need to play cooperatively."
    ),
    totranslate(
      "Tactics and deduction will be required to preserve the ice and the sky ..."
    ),
  ],
